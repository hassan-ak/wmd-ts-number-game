...
async function game(selectedMode) {
    ...
    let playAgainResponse = '⛔ No';
    // response to quit midway
    let quitMidwayResponse = '👍 No';
    /**********************************************************************/
    ...
    while (startGuessing) {
        ...
        if (selectedMode === 'Newbie' ||
            ...
            if (guessedNumber === generatedNumber) {
                ...
                console.log(`\n🎆 🏅 🎆 ${chalk.bgGreen.bold(' Congratulation ')}: You guessed the number in ${chalk.magenta(guessNumber)} tries.\n`);
            ...
            // in case of expert mode generate new number
                ...
                console.log(`\n❌ Wrong Answer${hint(guessedNumber, generatedNumber, selectedMode, guessNumber)}\n`);
